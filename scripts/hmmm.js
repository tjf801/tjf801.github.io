...
Write.prototype.solve = function () {
	let element = document.getElementsByClassName('LearnModeProgressBar-value')[0];
	...
	if (element) {
		...
		for (let i = 0; i < remaining; i++) {
			setTimeout(() => {
				document.getElementById('user-answer').value = 'abcdefghijk';
				document.getElementById('js-learnModeAnswerButton').click();
				document.getElementsByClassName('js-learnModeOverrideIncorrect')[0].click();
			}, i * this.speed);
		}
	}
}
